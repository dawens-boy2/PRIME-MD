...
cmd({
    ...
    try {
        await reply("🔍 CHECKING FOR PRIME-MD UPDATES...");

        // Fetch the latest commit hash from GitHub
        const { data: commitData } = await axios.get("https://api.github.com/repos/dawens-boy2/PRIME-MD/commits/main");
        ...
        await reply("> PRIME MD UPDATING WAIT PLS 👨‍💻...");
